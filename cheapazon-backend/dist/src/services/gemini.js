...
exports.validateProductMatch = exports.extractKeywords = void 0;
...
const validateProductMatch = async (amazonTitle, aliTitle, priceRatio) => {
    const apiKey = process.env.GEMINI_API_KEY;
    if (!apiKey)
...
exports.validateProductMatch = validateProductMatch;
